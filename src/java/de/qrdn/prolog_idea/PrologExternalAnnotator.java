 ...
 */
public class PrologExternalAnnotator extends ExternalAnnotator<PsiFile, List<PrologExternalAnnotator.Issue>> {
	...
	public List<Issue> doAnnotate(final PsiFile file) {
		Collection<? extends PsiElement> funcNameNodes =
			XPath.findAll(PrologLanguage.INSTANCE, file, "/script/function/ID");
		Collection<? extends PsiElement> funcCallNameNodes =
			XPath.findAll(PrologLanguage.INSTANCE, file, "//call_expr/ID");
